...
public class Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonWriToFile = new javax.swing.JButton();
        ...
        jButtonWriToFile.setText("Write To File");
        jButtonWriToFile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonWriToFileActionPerformed(evt);
            }
        });
    ...
    private void jButtonWriToFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonWriToFileActionPerformed
        ...
        if (Integer.parseInt(jTextFieldID.getText()) < 7) {
        ...
        } else if (!chechEmail(jTextFieldEmail.getText()) || jTextFieldEmail.getText().length() < 4) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                try {
                    Utils.writeFromFile("Students", list);
                } catch (Exception ex) {
                    Logger.getLogger(Form.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }//GEN-LAST:event_jButtonWriToFileActionPerformed
    ...
    private void jButtonReadFromFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReadFromFileActionPerformed
        // TODO add your handling code here:
        String[] column = {" ID ", " Name ", " Pass ", " Email ", " Age ", " Gender ", " Hobby ", " Round ", " Note ",};
        DefaultTableModel tableModel = new DefaultTableModel(0, 9);
        
        tableModel.setColumnIdentifiers(column);
        jTable.setModel(tableModel);
        Utils.readFromFile("Students", tableModel);
    ...
    private javax.swing.JButton jButtonWriToFile;
